...
data1 <- readLAS(files = "50m_classified.las")
...
write.csv(cbind(pp,normals,data1@data$R2, data1@data$G2, data1@data$B2, 
                curvature,omnivariance,planarity,linearity,surf_var,anisotropy),
          file = "computed_features_all_data.txt", row.names = FALSE)
